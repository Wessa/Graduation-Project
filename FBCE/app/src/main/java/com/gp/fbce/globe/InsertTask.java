...
public class InsertTask extends AsyncTask<BusinessCard, Void, String> {
    ...
    @Override
    protected String doInBackground(BusinessCard... businessCards) {
        ...
        try {
            ...
            final String BASE_URL = "http://192.168.0.4:8080/bce_api/add_card.php?";
    ...
    public String getJsonResult( String json ) throws JSONException {
        ...
        if ( response.getString("error").equals("true") ){
            ...
            result = "error: " + response.getString("error_msg");
        }
        else {
