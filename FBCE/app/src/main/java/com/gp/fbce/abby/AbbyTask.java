...
/**
 * Created by Waseem on 6/19/2016.
 */
public class AbbyTask extends AsyncTask<String, String, Boolean> {

    public AbbyTask(ScanActivity activity) {
    ...
    protected Boolean doInBackground(String... args) {
        ...
        try {
            ...
            restClient.applicationId = "Graduation Project Test";
            // You should get e-mail from ABBYY Cloud OCR SDK service with the application password
            restClient.password = "lpnn0xwm4u6g/IoWCrJPVYJ7";
            ...
            BusCardSettings cardSettings = new BusCardSettings();
            cardSettings.setOutputFormat(BusCardSettings.OutputFormat.xml);
            cardSettings.setLanguage(language);
            ...
            Task task = restClient.processBusinessCard(inputFile, cardSettings);
