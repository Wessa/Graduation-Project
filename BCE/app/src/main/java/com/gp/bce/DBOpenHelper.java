...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    public static final String CARD_FNAME = "firstName";
    public static final String CARD_LNAME = "lastName";
    ...
    public static final String[] ALL_COLUMNS = {
            CARD_ID, CARD_FNAME, CARD_LNAME, CARD_PHONE, CARD_EMAIL, CARD_ADDRESS,
            CARD_COMPANY, CARD_TITLE, CARD_NOTE, CARD_WEBSITE, CARD_FRONT, CARD_CREATED };
